        ...
        {consentStatus === "approved" && (
           <>
            <CardHeader className="bg-blue-50 border-b border-blue-100 flex flex-row items-center gap-4 py-6">
              <div className="w-12 h-12 rounded-full bg-blue-600 text-white flex items-center justify-center shadow-inner">
                 <UserPlus size={24} />
              </div>
              <div>
                      ...
                      {medicalHistory.map((rec, i) => (
                         <div key={i} className="bg-white p-3.5 rounded-lg border border-slate-200 text-sm space-y-1">
                            ...
                            <div className="text-xs text-slate-600 flex justify-between">
                               ...
                               <span className="font-semibold text-blue-600">{rec.actionTaken}</span>
                            </div>
